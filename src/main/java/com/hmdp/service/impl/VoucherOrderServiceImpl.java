...
//                    );
//                    // 2. 判断是否获取成功
//                    // 2.1 如果获取失败，说明pending-list没有信息，结束循环
//                    if(list == null || list.isEmpty()){
//                        break;
//                    }
//                    // 3. 解析消息
...
//    }
     ...
     * 子线程
     */
    @Override // 改为 public 方便监听器调用，并确保它是接口对应的方法或正确定义
...
//        RLock lock = redissonClient.getMultiLock(lock1, lock2, lock3);
    ...
    public Result seckillVoucher(Long voucherId) {
        ...
        Long result = stringRedisTemplate.execute(
                ...
                voucherId.toString(), userId.toString() // 移除 orderId
        );
        // 2. 判断结果是否为0
        ...
        // 4. 发送到 RabbitMQ
        rabbitTemplate.convertAndSend("order.queue", voucherOrder);
